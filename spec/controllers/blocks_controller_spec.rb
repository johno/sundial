  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved block as @block" do
        ...
        post :create, {:block => { "started_at" => "invalid value" }}, valid_session
        assigns(:block).should be_a_new(Block)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested block" do
        ...
        Block.any_instance.should_receive(:update).with({ "started_at" => "2014-02-19 18:52:43" })
        put :update, {:id => block.to_param, :block => { "started_at" => "2014-02-19 18:52:43" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the block as @block" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Block.any_instance.stub(:save).and_return(false)
        put :update, {:id => block.to_param, :block => { "started_at" => "invalid value" }}, valid_session
        assigns(:block).should eq(block)
      end
